...
namespace CouchBrowse
{
	partial class NewDocForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtContent.Size = new System.Drawing.Size(326, 139);
			...
			this.label1.Text = "Enter the content for the new document below. This must be valid JSON. Use the ex" +
			"ample button for a template.";
			// 
			// btnExample
			// 
			this.btnExample.Location = new System.Drawing.Point(263, 196);
